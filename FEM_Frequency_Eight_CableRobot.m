function [f2,K1,M1,nodeCoordinates,elementNodes]=FEM_Frequency_Eight_CableRobot(E,w,A,n,T,Ax,Ay,Az,a,b)
...
for e=1:elementNumbers;
    ...
    mass(elementDof,elementDof)= mass(elementDof,elementDof)+(w*L/(6*g))*[2*I, I;I, 2*I];
end
